...
--
-- Host: localhost    Database: MeetoPlayDB
-- ------------------------------------------------------
...
CREATE TABLE `event` (
  ...
  KEY `gameId` (`gameId`),
  KEY `eventOwnerId` (`eventOwnerId`),
  CONSTRAINT `event_ibfk_1` FOREIGN KEY (`eventRequirementId`) REFERENCES `eventRequirement` (`eventRequirementId`),
  CONSTRAINT `event_ibfk_2` FOREIGN KEY (`gameId`) REFERENCES `game` (`gameId`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `event_ibfk_3` FOREIGN KEY (`eventOwnerId`) REFERENCES `user` (`userId`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `event` VALUES (1,'Tardecita de Lol',1,'Aram','PC',11,'2023-12-17','2023-12-17','17:00:00','23:00:00',1,'Vaker0,Natty,Chriss',5,'2023-12-01','2023-12-17','16:08:41','15:00:00'),(2,'Minecraft Server',4,'Moded','PC / XBox',11,'2023-12-11','2023-12-18','19:30:00','24:00:00',NULL,'Natty,Vaker0,!TT7,SerialBan,Chriss,Pepelu,Joselito67,Rtt62,KillezMAzter,GiveupPaper,NoobPepito,XSunrise,GhostSkill,FreedomShoot,JackpotS,Aeroyep,orundG3,KekPlaie',20,'2023-12-01','2023-12-11','11:08:41','19:00:00'),(3,'Duo Valorant',2,'Ranked','PC',13,'2023-12-01','2023-12-01','17:00:00','19:30:00',2,'',1,'2023-12-01','2023-12-01','15:08:41','19:30:00'),(4,'Torneo CSgo',3,'Competitivo','PC',12,'2023-12-13','2023-12-15','16:30:00','21:00:00',NULL,'Natty,KillerZXN,Turkito,AroonP8',50,'2023-12-01','2023-12-13','15:08:41','16:30:00');
...
INSERT INTO `user` VALUES (1,'cingledew0','img/profilePics/defaultProfilePic.jpg','Active','ktulk0@sbwire.com','1e34f88f592fca06049b38a7190ad162','1998-06-17'),(2,'kelement1','img/profilePics/defaultProfilePic.jpg','Active','rgodball1@state.tx.us','b25a540ba78c5d7929ba6ac438b8568c','2004-12-29'),(3,'posborn2','img/profilePics/defaultProfilePic.jpg','AFK','aganiclef2@is.gd','a5bec5834592dc1d5619234d7add8b4a','1997-10-21'),(4,'mmolohan3','img/profilePics/defaultProfilePic.jpg','DND','jhyslop3@hc360.com','c8ef0e4bdb3f0620b82481b957ac6dd1','2000-04-03'),(5,'dtooker4','img/profilePics/defaultProfilePic.jpg','Active','jkirrens4@wikimedia.org','665af8fe6576175a1f35c52ff4214f6c','2001-11-02'),(6,'vpirouet5','img/profilePics/defaultProfilePic.jpg','Active','rbroome5@blogger.com','6aa1150de6a0d41ac271e0f2c236ed95','1994-09-06'),(7,'sromushkin6','img/profilePics/defaultProfilePic.jpg','Active','eleadbetter6@cam.ac.uk','aa4df9b0e4708dd726420e547bb710e8','1996-10-17'),(8,'hsarton7','img/profilePics/defaultProfilePic.jpg','Active','sblodg7@thetimes.co.uk','dcd814f8ddbc5a2ab01f95e463d5b60c','2003-11-25'),(9,'tfarlow8','img/profilePics/defaultProfilePic.jpg','Active','emarquis8@theatlantic.com','033e24529c5f76c29a873e5ed4c5d970','2001-03-19'),(10,'egorioli9','img/profilePics/defaultProfilePic.jpg','Active','djermy9@liveinternet.ru','0672c309adebe8c62dce9770b320b915','1999-03-11'),(11,'Seryix','img/profilePics/seryixProfilePic.jpg','DND','prueba@prueba.es','c893bad68927b457dbed39460e6afd62','2000-01-01'),(12,'Vaker0','img/profilePics/vakeroProfilePic.jpg','Active','dani.vakero.1@gmail.com','81dc9bdb52d04dc20036dbd8313ed055','2000-02-08'),(13,'Natty','img/profilePics/nattyProfilePic.jpg','AFK','natty@gmail.com','81dc9bdb52d04dc20036dbd8313ed055','1998-09-10'),(16,'makinonBikes','img/profilePics/defaultProfilePic.jpg','Active','alberto@moreno','202cb962ac59075b964b07152d234b70','1978-01-01'),(20,'nuevoRegistro','/img/profilePics/defaultProfilePic.jpg','Active','nuevo@registro.com','81dc9bdb52d04dc20036dbd8313ed055','2023-12-01');
...
INSERT INTO `user_join_event` VALUES (12,1),(13,1),(11,2),(12,2),(13,2),(13,4);
